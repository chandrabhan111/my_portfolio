  ...
  const projectsList = [
    {
      ...
      desc: 'A high-performance real estate mobile platform that simplifies property finding. Engineered a secure, scalable backend with high-speed search queries, custom filtering algorithms, and interactive client maps.',
      architecture: [
        'React Native Client',
        'JWT Auth',
        'Express API',
      ...
      tags: ['Node.js', 'Express.js', 'MongoDB', 'React Native'],
